        ...
        <div class="col-md-2" style="margin-left: 1em !important;margin-top: 6em !important;">
            ...
            <div class="portlet-body" >
                <ul id="sortable" class="list-group">
                    <li class="list-group-item "><a href="{{asset(ucfirst($main))}}">{{ucfirst($main)}}</a></li>
                    @foreach($item as $i)
                        <li class="list-group-item <?php echo $i->sub_name == $sub?'active':'' ?> "><a href="{{asset($main.'/'.$i->sub_name)}}">{{$i->sub_name}}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
